- [一、JAVA基础](#一java基础)
  ...
  - [1.2、多线程](#12多线程)
  - [1.3、线程池](#13线程池)
  - [1.4、NIO && IO多路复用模型](#14nio--io多路复用模型)
  - [1.5、java中的锁](#15java中的锁)
  - [1.6、延时队列](#16延时队列)
- [二、JVM](#二jvm)
  - [2.1、JVM结构](#21jvm结构)
  - [2.2、类加载机制](#22类加载机制)
...
- [四、Kafka](#四kafka)
  - [4.1、两种消息模型](#41两种消息模型)
  - [4.2、kafka结构原理](#42kafka结构原理)
  - [4.3、kafka消费策略](#43kafka消费策略)
  - [4.4、kafka扩容，重新分区](#44kafka扩容重新分区)
  - [4.5、性能优化](#45性能优化)
- [五、RabbitMQ](#五rabbitmq)
  - [5.1、结构原理](#51结构原理)
  - [5.2、消息调度策略](#52消息调度策略)
  - [5.3、消息确认机制（Message Acknowledgment）](#53消息确认机制message-acknowledgment)
  - [5.4、消息分发机制](#54消息分发机制)
  - [5.5、持久化 & 死信队列 & 延时队列](#55持久化--死信队列--延时队列)
- [六、Redis](#六redis)
  - [6.1、Reids数据类型](#61reids数据类型)
  - [6.2、缓存雪崩 & 缓存穿透 & 缓存击穿](#62缓存雪崩--缓存穿透--缓存击穿)
  - [6.3、双写一致性问题](#63双写一致性问题)
  - [6.4、分布式锁](#64分布式锁)
  - [6.5、延时队列](#65延时队列)
  - [6.6、Redis持久化](#66redis持久化)
  - [6.7、集群同步机制](#67集群同步机制)
  - [6.8、redis slot 槽点](#68redis-slot-槽点)
  - [6.8、HA集群高可用](#68ha集群高可用)
  - [6.9、数据淘汰策略（6种）](#69数据淘汰策略6种)
  - [6.10、Redis为什么快](#610redis为什么快)
  - [6.11、Redis与Memcached区别](#611redis与memcached区别)
- [七、ZooKeeper](#七zookeeper)
  - [7.1、结构原理](#71结构原理)
  - [7.2、选主投票机制](#72选主投票机制)
  - [7.3、应用场景](#73应用场景)
  - [7.4、](#74)
...
- [八、分布式](#八分布式)
  ...
  - [8.3、服务降级](#83服务降级)
  - [8.4、高可用](#84高可用)
  - [8.5、一致性HASH算法](#85一致性hash算法)
  - [8.6、分布式文件存储](#86分布式文件存储)
- [九、ElasticSearch](#九elasticsearch)
  - [9.1、ES分布式架构原理](#91es分布式架构原理)
  - [9.2、如何合理设计分片和副本](#92如何合理设计分片和副本)
  - [9.3、ES数据流程](#93es数据流程)
  - [9.4、检索](#94检索)
  - [9.5、score计算](#95score计算)
  - [9.6、ES的性能优化](#96es的性能优化)
  - [9.7、生产部署](#97生产部署)
  - [9.7、倒排索引](#97倒排索引)
- [十、开发框架](#十开发框架)
  - [10.1、spring](#101spring)
  - [10.2、mybatis](#102mybatis)
- [十一、Design Pattern](#十一design-pattern)
- [十二、Dev Utils](#十二dev-utils)
  - [11.1、Git](#111git)
...
### 3.1、mysql的存储引擎
  ...
  - __MyIsam：__
    - MyIASM是 MySQL默认的引擎，但是它没有提供对数据库事务的支持，也不支持行级锁和外键，索引文件和数据文件分开（可以在内存中缓存更多的数据），
